...
export const data = [
    {id: 1, title: 'Тренировки', icon: heard, description: 'Расписать тренировки', callback: () => {
            console.log()}, dataId: 'menu-button-calendar1'},
    {id: 2, title: 'Календарь', icon: cal, description: 'Назначить календарь', callback: calendarThunks.training, dataId: 'menu-button-calendar1'},
    {id: 3, title: 'Профиль', icon: prof, description: 'Заполнить профиль', callback: () => {
            console.log()}, dataId: 'menu-button-calendar1'},
];

export const menuItem = [
    {id: 1, title: 'Календарь', icon: icrasp, callback: calendarThunks.training, dataId: 'menu-button-calendar'},
