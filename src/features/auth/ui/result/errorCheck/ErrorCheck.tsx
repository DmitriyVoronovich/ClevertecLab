        ...
        <div className={'log_error_container'} style={{backgroundImage: `url(${fon})`}}>
            ...
            <div className={'error_check_container'}>
                <div className={'error_check_wrapper'}>
                    ...
                    <p className={'error_check_description'}>Произошла ошибка, попробуйте отправить
                        форму ещё раз.</p>
                    <Button data-test-id='check-back-button' type="primary"
                            className={'error_check_button'}
                            onClick={redirectToLogin}>Назад</Button>
                </div>
            </div>
        </div>
    );
