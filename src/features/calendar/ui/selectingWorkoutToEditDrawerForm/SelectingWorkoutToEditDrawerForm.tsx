...
const InputItem = ({name, handleCheckboxChange, index, restField}) => {
    return (
        <Form.Item
            {...restField}
            name={[name, 'name']}
                    ...
                    <>
                        {fields.map(({ key, name, ...restField}, index) => (
                            <div key={key} className={'form_item'}>
                                <div>
                                   <InputItem restField={restField} name={name} index={index} handleCheckboxChange={handleCheckboxChange}/>
                                </div>
