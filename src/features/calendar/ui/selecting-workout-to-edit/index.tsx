...
import { SelectingWorkoutToEditProps } from './types/types.ts';
import { transformDate } from './utils/transform-date.ts';

import '../add-training-modal/add-training-modal.css';
